...
function createProgram(gl: WebGL2RenderingContext, shaderSources: string[], transformFeedbackVaryings?: string[] | null, attribLocations?: { [key: string]: number }) {
...
function makeBuffer(gl: WebGL2RenderingContext, sizeOrData: Float32Array | ArrayBufferView, usage: number) {
...
class InfiniteGridMenu {
  ...
  constructor(canvas: HTMLCanvasElement, items: any[], onActiveItemChange: (index: number) => void, onMovementChange: (isMoving: boolean) => void, onInit: ((menu: InfiniteGridMenu) => void) | null = null) {
    this.canvas = canvas;
    this.items = items || [];
